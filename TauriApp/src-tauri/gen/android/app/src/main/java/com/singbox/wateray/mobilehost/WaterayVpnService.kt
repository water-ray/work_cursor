...
import com.singbox.wateray.BuildConfig
import com.singbox.wateray.R
...
class WaterayVpnService : VpnService(), CommandServerHandler, PlatformInterface {
  companion object {
    ...
    private const val ACTION_START = "com.singbox.wateray.mobilehost.START"
    private const val ACTION_STOP = "com.singbox.wateray.mobilehost.STOP"
