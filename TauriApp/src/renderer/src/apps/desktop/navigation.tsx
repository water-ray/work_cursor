...
export const desktopNavRoutes: NavRoute[] = [
  {
    key: "proxy",
    path: "/proxy",
    title: "代理",
...
export function resolveDesktopTitle(pathname: string): string {
  const route = desktopNavRoutes.find((item) => pathname.startsWith(item.path));
